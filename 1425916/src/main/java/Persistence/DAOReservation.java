...
public interface DAOReservation {
   ...
   */
    boolean create (int orderId, int boxId, int invoiceId, String customer, String reservationFrom, String reservationTo, int duration, double price, String horse, boolean isDeleted);

    /*updates the invoice if input and its key match
     returns true in case of success, false otherwise
      */
    boolean update(int orderId, int boxId, int invoiceId, String customer, String reservationFrom, String reservationTo, int duration, double price, String horse, boolean isDeleted);
